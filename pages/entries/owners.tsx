...
import {OwnerForm, PageContent, PageHeading} from '@/components';
import {useWeb3} from '@/hooks/useWeb3';
import {addEllipsis} from '@/utils/string';

const OwnersEntry = (): JSX.Element | null => {
...
export default withPublicLayout(OwnersEntry);
